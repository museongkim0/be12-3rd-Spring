...
public enum BoardResponseStatus implements BaseResponseStatus {
    // 6000번대 - Board 관련 에러
    BOARD_NOT_FOUND(false, 6001, "게시판 정보를 찾을 수 없습니다."),
    POST_NOT_FOUND(false, 6002, "게시글을 찾을 수 없습니다."),
    DUPLICATE_POST(false, 6003, "이미 존재하는 게시글입니다."),
    INVALID_POST_ID(false, 6004, "잘못된 게시글 ID입니다."),
